    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="flex justify-center mb-12">
        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[hsl(var(--primary))] shadow-lg">
          <img 
            src="/curriculovb/images/foto-vb.png"
            alt="Vinicius Becker"
      ...
      <div className="grid gap-8 md:grid-cols-2 max-w-4xl mx-auto">
        ...
        <div className="portfolio-card">
          ...
          <p className="text-[hsl(var(--text-secondary))] leading-relaxed">
            Experiências acadêmicas em desenvolvimento de software, arquitetura de sistemas, trabalho 
            em equipe, projetos como GreenFund (.NET Core, Oracle, xUnit, Swagger) e Sistema de Cursos 
            (Java, Spring Boot, Oracle), além de experiência com Azure.
          </p>
        </div>
      </div>
    </div>
